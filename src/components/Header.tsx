const Header = () => (
  <div className="relative px-6 py-48">
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute top-0 left-0 w-64 h-64 bg-orange-500 rounded-full opacity-30 transform -translate-x-[7rem] -translate-y-20"></div>
    ...
    <div className="relative flex flex-col md:flex-row items-center justify-between mb-8">
      <div className="md:w-1/2 md:mb-0 mb-4 pl-20">
