...
const ProfileCard: React.FC<ProfileProps> = ({
  ...
  return (
    <>
      <div className="container mx-auto max-w-screen-lg min-h-min p-4 py-6 rounded-md ">
        <div className="flex lg:flex-row flex-col items-center lg:items-start lg:justify-normal justify-center lg:gap-8 gap-4">
          <div className="flex flex-col gap-2 w-1/2 justify-center items-center">
            ...
            <div className="flex flex-col justify-center">
              <h2 className="text-2xl text-center font-semibold text-[#11133c]">
                {name}
              </h2>
              <span className="text-center text-sm text-gray-700">{title}</span>
          ...
          <div className="w-full">
            <div className="px-4">
              ...
              <ul className="list-disc px-4 text-[#11133c]">
                <li>
